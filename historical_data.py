...
class HistoricalData:
    def __init__(self, data) -> None:
        ...
        self.max_temp: str = self.data["data"]["weather"][0]["maxtempC"]  # Hämtar max temperatur
    ...
    def get_historical_data(self) -> Any:
        ...
        while attempt_search:  # Loop för att kunna söka efter flera städer utan att programmet avslutas
            try:
                ...
                result = self.fetch_historical_data(city, date)  # Tar input från användaren och skickar upp det till metoden för att kunna skapa API-länken
                return result
